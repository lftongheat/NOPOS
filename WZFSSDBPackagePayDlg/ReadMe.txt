========================================================================
		ActiveX Control DLL : CSDBPACKAGEPAYDLG
========================================================================

ControlWizard has created this project for your CSDBPACKAGEPAYDLG ActiveX Control
...
that make up your CSDBPACKAGEPAYDLG ActiveX Control DLL.

CSDBPackagePayDlg.dsp
...
CSDBPackagePayDlg.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
CSDBPackagePayDlg control:

CSDBPackagePayDlgCtl.h
	This file contains the declaration of the CCSDBPackagePayDlgCtrl C++ class.

CSDBPackagePayDlgCtl.cpp
	This file contains the implementation of the CCSDBPackagePayDlgCtrl C++ class.

CSDBPackagePayDlgPpg.h
	This file contains the declaration of the CCSDBPackagePayDlgPropPage C++ class.

CSDBPackagePayDlgPpg.cpp
	This file contains the implementation of the CCSDBPackagePayDlgPropPage C++ class.

CSDBPackagePayDlgCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCSDBPackagePayDlgCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CSDBPackagePayDlg.rc.
